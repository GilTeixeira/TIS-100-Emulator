...
class ArgumentValue extends AbsArgument {
    constructor(readonly node: BasicExecutionNode, readonly value: number) {
        super();
        this.isNumber = true;
    }
...
class ArgumentACC extends AbsArgument {
...
class ArgumentDir extends AbsArgument {
    constructor(readonly node: BasicExecutionNode, readonly direction: Directions) {
        super()
